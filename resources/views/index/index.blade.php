	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6 order-2 order-md-1 text-center text-md-left">
				<h1 class="text-white font-weight-bold mb-4">Bienvenidos a Nuestra Empresa</h1>
				<p class="text-white mb-5">Lorem ipsum dolor sit amet consectetur adipisicing, elit. Eaque, necessitatibus.</p>
				<!-- <a href="FAQ.html" class="btn btn-main-md">Download Now</a> -->
			</div>
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="img/campo.jpg" alt="screenshot">
			</div>
		</div>
	</div>
</section>
		...
		<div class="rounded shadow p-5 bg-white">
			<div class="row">
				<div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
					...
					<h3 class="mt-4 text-capitalize h5 ">Productos de buena calidad</h3>
				...
				<div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
					...
					<h3 class="mt-4 text-capitalize h5 ">100% Natural</h3>
					<p class="regular text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam non, recusandae
						tempore ipsam dignissimos molestias.</p>
				</div>
				<div class="col-lg-4 col-md-12 mt-5 mt-lg-0 text-center">
					<!-- <i class="ti-thought text-primary h1"></i> -->
					<h3 class="mt-4 text-capitalize h5 ">Productos Económicos</h3>
					<p class="regular text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam non, recusandae
						tempore ipsam dignissimos molestias.</p>
					</p>
				</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto align-self-center">
				<div class="feature-content">
					<!-- Feature Title -->
					<h2>Una empresa compremetida con sus Clientes <!-- <a
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 ml-auto align-self-center">
				<div class="feature-content">
					<!-- Feature Title -->
					<h2>Productos que Brindan Felicidad <!-- <a
							href="https://themefisher.com/products/small-apps-free-app-landing-page-template/">Small Apps</a> --></h2>
					<!-- Feature Description -->
