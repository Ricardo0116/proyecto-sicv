...
<li class="nav-item ">
<a class="nav-link" href="{{url('dashboard')}}" data-toggle="" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fas fa-desktop"></i>Dashboard <span class="badge badge-success">6</span></a>
</li>
<li class="nav-item">
